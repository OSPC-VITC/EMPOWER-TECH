...
const Hero = () => {
  return (
    <section className="flex flex-col items-center justify-center hero min-h-screen  rounded-lg w-full bg-background bg-black overflow-hidden pt-5 gap-10 relative">
